...
const Projects = () => {
  return (
    <div>
     {/* <!-- component --> */}
<div className="2xl:mx-auto  mx-4 py-16 ">
  ...
  <div className="w-full relative flex items-center justify-center">
    ...
    <div className="flex mt-8 space-x-6 text-white">
      ...
      <h1 className="text-4xl  font-semibold leading-9 text-white text-center">Have any projects in mind?</h1>
      <div className="sm:border border-white flex-col sm:flex-row flex items-center  w-42 mt-12 space-y-4 text-center sm:space-y-0">
        <button className="  border-2 border-custom-primary  w-24 sm:w-auto  py-6 px-6 ">GET STARTED</button>
      </div>
    </div>
  </div>
</div>
